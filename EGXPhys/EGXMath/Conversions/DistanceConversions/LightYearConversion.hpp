/// @file EGXMath/Conversions/DistanceConversions/LightYearConversion.hpp
///
/// @brief Converts distance measurements from light year units into various other units such as meters, parsecs.
///
/// @author Elliot Grafil (Metex)
/// @date 5/31/18

/// @defgroup EGXMath-Conversions-DistanceConversions-LightYear Light Year
...
namespace EGXMath
{
    /// @addtogroup EGXMath-Conversions-DistanceConversions-LightYear
    /// @{

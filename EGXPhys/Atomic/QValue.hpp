...
{	
	...
	*	@see QValueElectronCaptureDecayInMeV() to calculate Q-Value for a electron capture decay reaction in mega electron volts.
	...
	*	@see QValueElectronCaptureDecayInJ() to calculate Q-Value for a electron capture decay reaction in joules.

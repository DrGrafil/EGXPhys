/// @file EGXMath/Conversions/DistanceConversions/ParsecConversion.hpp
///
/// @brief Converts distance measurements from parsec units into various other units such as meters, light years.
///
/// @author Elliot Grafil (Metex)
/// @date 5/31/18

/// @defgroup EGXMath-Conversions-DistanceConversions-Parsec Parsec
...
namespace EGXMath
{
    /// @addtogroup EGXMath-Conversions-DistanceConversions-Parsec
    /// @{

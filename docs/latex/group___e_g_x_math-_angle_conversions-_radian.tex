...
\begin{DoxyCompactList}\small\item\em Converts an angle in radians to (decimal) degree. \[\alpha_{mrad}=\alpha_{rad}*10^3\]. \end{DoxyCompactList}\item 
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
$\alpha_{arcmin} (arcmin)$ is the angle in arcminutes. 
\end{DoxyReturn}
\begin{DoxySeeAlso}{See also}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
$\alpha_{arcsec} (arcsec)$ is the angle in arcseconds. 
\end{DoxyReturn}
\begin{DoxySeeAlso}{See also}
...
\hline
{\em arcminute} & $arcminute(arcmin)$ is the angle in arcminute in whole numbers. \\
\hline
{\em arcsecond} & $arcsecond (arcsec)$ is the angle in arcsecond. \\
\hline
\end{DoxyParams}
\begin{DoxySeeAlso}{See also}
...
Converts an angle in radians to (decimal) degree. \[\alpha_{mrad}=\alpha_{rad}*10^3\]. 

...
Calculates the torque, $\tau$, in Newton meters. Torqu on an object is calculated from the force, $F$, applied to an object at a position $r$ away from the fulcrum(pivot point)\+: \[\tau=r \times F \]. 

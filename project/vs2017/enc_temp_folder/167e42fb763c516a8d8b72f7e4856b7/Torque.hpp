...
namespace EGXPhys
{
	...
	/**
	*   @brief Calculates the torque, \f$\tau\f$, in Newton meters. Torqu on an object is calculated from the force, \f$F\f$, applied to an object at a position \f$r\f$ away from the fulcrum(pivot point):
	*   		\f[\tau=r \cross F \f]
	*

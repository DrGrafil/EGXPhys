...
namespace EGXPhys
{
    ...
    EGXPHYS_CONSTANT sunLuminosity = 3.828e26;                                  /**< \f$ L_{\odot} \ (W)\f$ Luminosity (bolometric) of Sun in watts. Defined by IAU. See https://sites.google.com/site/mamajeksstarnotes/basic-astronomical-data-for-the-sun */
    EGXPHYS_CONSTANT solarLuminosity = sunLuminosity;                           /**< \f$ L_{\odot} \ (W)\f$ Luminosity (bolometric) of Sun in watts. Defined by IAU. See https://sites.google.com/site/mamajeksstarnotes/basic-astronomical-data-for-the-sun */
    ...
    ***************************/
    ...
    EGXPHYS_CONSTANT mercuryVolumetricMeanRadius = 2439.7e3;                    /**< \f$R_{Me} \ (kg)\f$ Volumetric mean radius of Mercury in meters. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/mercuryfact.html */
    ...
    EGXPHYS_CONSTANT venusVolumetricMeanRadius = 6051.8e3;                      /**< \f$R_{V} \ (kg)\f$ Volumetric mean radius of Venus in meters. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/venusfact.html */
    ...
    EGXPHYS_CONSTANT earthVolumetricMeanRadius = 6371.000e3;                    /**< \f$R_{\oplus} \ (kg)\f$ Volumetric mean radius of Earth in meters. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/earthfact.html */
    ...
    EGXPHYS_CONSTANT moonVolumetricMeanRadius = 1737.4e3;                       /**< \f$R_{\circ} \ (kg)\f$ Volumetric mean radius of Moon in meters. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/moonfact.html */
    ...
    EGXPHYS_CONSTANT marsVolumetricMeanRadius = 3389.5e3;                       /**< \f$R_{Ma} \ (kg)\f$ Volumetric mean radius of Mars in meters. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/marsfact.html */
    ...
    EGXPHYS_CONSTANT jupiterVolumetricMeanRadius = 69911000;                    /**< \f$R_{J} \ (kg)\f$ Volumetric mean radius of Jupiter in meters. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/jupiterfact.html */
    ...
    EGXPHYS_CONSTANT saturnVolumetricMeanRadius = 58232e3;                      /**< \f$R_{S} \ (kg)\f$ Volumetric mean radius of Saturn in meters. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/saturnfact.html */
    ...
    EGXPHYS_CONSTANT uranusVolumetricMeanRadius = 25362e3;                      /**< \f$R_{U} \ (kg)\f$ Volumetric mean radius of Uranus in meters. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */
    ...
    EGXPHYS_CONSTANT neptuneVolumetricMeanRadius = 24622e3;                     /**< \f$R_{N} \ (kg)\f$ Volumetric mean radius of Neptune in meters. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/neptunefact.html */
    ...
    EGXPHYS_CONSTANT plutoVolumetricMeanRadius = 1187e3;                        /**< \f$R_{Pl} \ (kg)\f$ Volumetric mean radius of Pluto in meters. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/plutofact.html */

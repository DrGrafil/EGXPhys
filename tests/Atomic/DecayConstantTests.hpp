TEST_CASE("Decay Constant"){
	...
	CHECK( DecayConstant(1000.0, 800.0, 2.0) == Approx(0.112).epsilon(0.001));
	
	CHECK( DecayConstantViaHalfLife(log(2.0)) == 1.0 );
	CHECK( DecayConstantViaHalfLife(1.0) == log(2.0) );
	CHECK( DecayConstantViaHalfLife(30.17) == Approx(0.0230).epsilon(0.001) );
	CHECK( DecayConstantViaHalfLife(20.0) == Approx(0.03465).epsilon(0.001) );
	CHECK( DecayConstantViaHalfLife(20.0) == Approx(0.03465).epsilon(0.001) );

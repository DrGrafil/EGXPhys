/// @file EGXMath/Conversions/DistanceConversions/MeterConversion.hpp
///
/// @brief Converts distance measurements from meter units into various other units such as parsecs, light years.
///
/// @author Elliot Grafil (Metex)
/// @date 5/31/18

/// @defgroup EGXMath-Conversions-DistanceConversions-Meter Meter
...
namespace EGXMath
{
    /// @addtogroup EGXMath-Conversions-DistanceConversions-Meter
    /// @{

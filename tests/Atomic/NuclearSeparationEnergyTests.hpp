TEST_CASE("Nuclear Separation Energy"){
	...
	//Carbon 12
	CHECK( NeutronSeparationEnergyInMeV(12.0,11.011433611)== Approx(18.7216).epsilon(0.001));
	CHECK( NeutronTwoSeparationEnergyInMeV(12.0,10.016853230)== Approx(31.8414).epsilon(0.001));
	CHECK( ProtonSeparationEnergyInMeV(12.0,11.009305404)== Approx(15.9568).epsilon(0.001));
	CHECK( ProtonTwoSeparationEnergyInMeV(12.0,10.013534679)== Approx(27.18543).epsilon(0.001));
	
		//Joule check
	CHECK( NeutronSeparationEnergyInJ(12.0,11.011433611)== Approx(18.7216e6 * NISTConst::electronVoltToJoule).epsilon(0.001));
	CHECK( NeutronTwoSeparationEnergyInJ(12.0,10.016853230)== Approx(31.8414e6* NISTConst::electronVoltToJoule).epsilon(0.001));
	CHECK( ProtonSeparationEnergyInJ(12.0,11.009305404)== Approx(15.9568e6* NISTConst::electronVoltToJoule).epsilon(0.001));
	CHECK( ProtonTwoSeparationEnergyInJ(12.0,10.013534679)== Approx(27.18543e6* NISTConst::electronVoltToJoule).epsilon(0.001));

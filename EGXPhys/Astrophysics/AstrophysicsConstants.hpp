...
namespace EGXPhys
{
    ...
    ***************************/
    ...
    EGXPHYS_CONSTANT marsGravitationalMass = 0.042828e15;                       /**< \f$ GM_{Ma} \ (\dfrac{m^3}{s^2})\f$ Gravitational constant times the mass of Mars in meter cubed per second squared. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/marsfact.html */
    ...
    EGXPHYS_CONSTANT saturnGravitationalMass = 37.931e15;                       /**< \f$ GM_{S} \ (\dfrac{m^3}{s^2})\f$ Gravitational constant times the mass of Saturn in meter cubed per second squared. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/saturnfact.html */
    ...
    /// @{
    EGXPHYS_CONSTANT uranusMass = 86.813e24;                                    /**< \f$M_{ZSZ} \ (kg)\f$ Mass of Uranus in kilograms. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */
    EGXPHYS_CONSTANT uranusDensity = 1271.0;                                    /**< \f$\rho_{ZSZ} \ (\dfrac{kg}{m^3})\f$ Density of Uranus in kg per meter cubed. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */

    EGXPHYS_CONSTANT uranusRadiusEquatorial = 25559e3;                          /**< \f$R_{ZSZ,Equat} \ (m)\f$ Equatorial radius of Uranus in meters. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */
    EGXPHYS_CONSTANT uranusRadiusPolar = 24973e3;                               /**< \f$R_{ZSZ,Polar} \ (m)\f$ Polar radius of Uranus in meters. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */
    EGXPHYS_CONSTANT uranusVolumetricMeanRadius = 25362e3;                      /**< \f$M_{ZSZ} \ (kg)\f$ Volumetric mean radius of Uranus in meters. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */
   
    EGXPHYS_CONSTANT uranusFlattening = 0.02293;                                /**< \f$f_{ZSZ} \ (dimensionless)\f$ Flattening of Uranus. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */

    EGXPHYS_CONSTANT uranusGravitationalMass = 5.7940e15;                       /**< \f$ GM_{ZSZ} \ (\dfrac{m^3}{s^2})\f$ Gravitational constant times the mass of Uranus in meter cubed per second squared. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */
    EGXPHYS_CONSTANT uranusSurfaceGravityEquator = 8.87;                        /**< \f$ G_{ZSZ,Equat.} \ (\dfrac{m}{s^2})\f$ Equatorial gravitational acceleration at the surface of Uranus in meters per second squared. Does not including the effects of rotation. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */
    EGXPHYS_CONSTANT uranusSurfaceGravityPolar = 9.19;                          /**< \f$ G_{ZSZ,Polar} \ (\dfrac{m}{s^2})\f$ Equatorial gravitational acceleration at the surface of Uranus in meters per second squared. Does not including the effects of rotation. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */

    EGXPHYS_CONSTANT uranusGeometricAlbedo = 0.488;                             /**< \f$ p_{ZSZ} \ (dimensionless)\f$ Geometric albedo of Uranus. The ratio of the body's brightness at a phase angle of zero to the brightness of a perfectly diffusing disk with the same position and apparent size. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */
    EGXPHYS_CONSTANT uranusBondAlbedo = 0.300;                                  /**< \f$ A_{ZSZ} \ (dimensionless)\f$ Bond albedo of Uranus. The fraction of incident solar radiation reflected back into space without absorption. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */
    EGXPHYS_CONSTANT uranusVBandMagnitude = -7.11;                              /**< \f$ V(1,0)_{ZSZ} \ (dimensionless)\f$ Visual magnitude of Uranus if it were one AU from the Earth at a phase angle of zero . See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */
    EGXPHYS_CONSTANT uranusSolarIrradiance = 3.69;                              /**< \f$ Q_{ZSZ} \ (\dfrac{W}{m^2})\f$ Solar irradiance of Uranus in watts per meter squared. The solar energy landing on uranus per unit area. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */

    EGXPHYS_CONSTANT uranusMomentOfInertia = 0.225;                             /**< \f$ I_{ZSZ} \ (dimensionless)\f$ The moment of inertia of Uranus. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */
    EGXPHYS_CONSTANT uranusJ2 = 3343.43e-6;                                     /**< \f$ J_{2,ZSZ} \ (dimensionless)\f$ J_2 perterbation of Uranus. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */
    /// @}

    /// @addtogroup EGXPhys-Constants-Astrophysics-SolarSystem-Uranus-Orbit
    /// @{
    EGXPHYS_CONSTANT uranusSemimajorAxis = 2872.46e9;                           /**< \f$ a_{ZSZ} \ (m)\f$ Semi-major axis of Uranus in meters. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */
    EGXPHYS_CONSTANT uranusSiderealOrbitPeriod = 30685.4*secondsInDay;          /**< \f$ T_{ZSZ,sidereal} \ (s)\f$ Sidereal orbit period of Uranus in seconds. The time it takes the body to make one revolution about the Sun relative to the fixed stars. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */
    EGXPHYS_CONSTANT uranusTropicalOrbitPeriod = 30588.740*secondsInDay;        /**< \f$ T_{ZSZ,trop} \ (s)\f$ Tropical orbit period of Uranus in seconds. The average time for the body to make one revolution about the Sun from one point in its seasonal orbit to the equivalent point. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */
    EGXPHYS_CONSTANT uranusSynodicOrbitPeriod = 369.66*secondsInDay;            /**< \f$ T_{ZSZ,syn} \ (s)\f$ Synodic period of Uranus in seconds. The time between similar configurations in the orbit of the planet and Earth. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */
    EGXPHYS_CONSTANT uranusPerihelion = 2741.30e9;                              /**< \f$ r_{ZSZ,peri} \ (m)\f$ Perihelion of Uranus in meters. Distance when it is closets to the Sun. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */
    EGXPHYS_CONSTANT uranusAphelion = 3003.62e9;                                /**< \f$ r_{ZSZ,aphe} \ (m)\f$ Aphelion of Uranus in meters. Distance when it is furthest from the Sun. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */
    EGXPHYS_CONSTANT uranusOrbitInclination = 0.772;                            /**< \f$ \theta_{ZSZ,orbit} \ (deg)\f$ Orbit inclination of Uranus in degrees. The inclination of the orbit to the ecliptic. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */
    EGXPHYS_CONSTANT uranusOrbitEccentricity = 0.0457;                          /**< \f$ e_{ZSZ} \ (dimensionless)\f$ Orbit eccentricity of Uranus. A measure of the circularity of the orbit. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */

    EGXPHYS_CONSTANT uranusSiderealRotationPeriod = -17.24*secondsInHour;       /**< \f$ P_{ZSZ} \ (s)\f$ Sidereal rotation period of Uranus in seconds. Total time is 9h 55m 29.685s. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */
    // Weirdness with the rates reported EGXPHYS_CONSTANT uranusRotationRate = ;                          /**< \f$ \omega_{ZSZ} \ (\dfrac{rad}{s})\f$ Rotation rate of Uranus in radians per second. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */
    EGXPHYS_CONSTANT uranusDayLength = 17.24*secondsInHour;                     /**< \f$ Day_{ZSZ} \ (s)\f$ Length of a day in Uranus in second. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */
    EGXPHYS_CONSTANT uranusObliquityToOrbit = 97.77;                            /**< \f$ \theta_{ZSZ,obliq} \ (deg)\f$ Obliquity to orbit of Uranus in degrees. The angle between Uranus's equator and the it's orbital plane, with north defined by the right-hand rule. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */
    EGXPHYS_CONSTANT uranusInclinationOfEquator = 82.23;                        /**< \f$ \theta_{ZSZ,incli} \ (deg)\f$ Inclination of equator of Uranus in degrees. The angle between Uranus's equator and orbital plane with north defined as pole axis above (north of) the plane of the solar system. See NASA, Jet Propulsion Laboratory, Horizon for data https://ssd.jpl.nasa.gov/horizons.cgi . Accessed 7/16/18. Also see https://nssdc.gsfc.nasa.gov/planetary/factsheet/uranusfact.html */
    /// @}

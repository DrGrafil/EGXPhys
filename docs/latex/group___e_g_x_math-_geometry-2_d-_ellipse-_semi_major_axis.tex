...
Finds the semi-\/major axis, $a$, in meters of an ellipse with semi-\/minor axis $b$, and focal parameter $p$. \[ a=\sqrt{b^2+c^2} \]. 
...
Finds the semi-\/major axis, $a$, in meters of an ellipse with linear eccentricity $c$, and linear eccentricity $c$. \[ a=\sqrt{b^2+c^2} \]. 
...
Finds the semi-\/major axis, $a$, in meters of an ellipse with linear eccentricity $c$, and focal parameter $p$. \[ a=\sqrt{b^2+c^2} \]. 
...
Finds the semi-\/major axis, $a$, in meters of an ellipse with semi-\/minor axis $b$, and focal parameter $p$. \[ a=\dfrac{\ell}{1-\dfrac{\ell^2}{p^2}} \]. 

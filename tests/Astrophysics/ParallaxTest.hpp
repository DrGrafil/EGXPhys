...
TEST_CASE("Parallax"){
    ...
    CHECK(AstronomicalUnitToParsec(ParallaxToAstronomicalUnit(1.0)) == 1.0);
    CHECK(AstronomicalUnitToParsec(ParallaxToAstronomicalUnit(0.129)) == Approx(7.75).scale(0.0).epsilon(0.1));
